...
IF EXISTS (	SELECT name 
			FROM sysobjects
			WHERE  name = 'web_spS_ObtenerCambiosPreciarioPorVolumetria' AND
			TYPE = 'P')
	DROP PROCEDURE web_spS_ObtenerCambiosPreciarioPorVolumetria
GO
-- =============================================
-- Author:		Giovanni Flores
-- Create date: Miercoles 07 de Enero de 2015
-- Description:	Obtener registros por volumetria
-- =============================================
CREATE PROCEDURE web_spS_ObtenerCambiosPreciarioPorVolumetria
