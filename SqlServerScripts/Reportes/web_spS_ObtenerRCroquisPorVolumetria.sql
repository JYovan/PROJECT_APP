...
IF EXISTS (	SELECT name 
			FROM sysobjects
			WHERE  name = 'web_spS_ObtenerRCroquisPorVolumetria' AND
			TYPE = 'P')
	DROP PROCEDURE web_spS_ObtenerRCroquisPorVolumetria
GO

CREATE PROCEDURE web_spS_ObtenerRCroquisPorVolumetria
