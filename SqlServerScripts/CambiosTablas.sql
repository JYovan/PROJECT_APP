...
ALTER TABLE Clientes ALTER COLUMN FirmaInicial VARCHAR(100) NULL
ALTER TABLE Clientes ALTER COLUMN FirmaCentral VARCHAR(100) NULL
ALTER TABLE Clientes ALTER COLUMN FirmaFinal VARCHAR(100) NULL
