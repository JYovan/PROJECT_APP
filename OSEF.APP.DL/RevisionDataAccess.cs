...
namespace OSEF.APP.DL
{
    ...
    public class RevisionDataAccess
    {
        ...
        /// <summary>
        /// Método que obtiene un registro de Revision por la Sucursal
        /// </summary>
        ...
        public static Revision ObtenerRevisionPorSucursal(string strSucursal)
        {
            try
            {
                ...
                sqlcComando.Connection = sqlcConectar;
                sqlcComando.CommandType = CommandType.StoredProcedure;
                sqlcComando.CommandText = "web_spS_ObtenerRevisionPorSucursal";
            ...
            {
                throw new Exception("Error capa de datos (public static Revision ObtenerRevisionPorSucursal(string " + strSucursal + ")): " + ex.Message);
            }
        }
