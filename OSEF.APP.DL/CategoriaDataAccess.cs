...
namespace OSEF.APP.DL
{
    ...
    public class CategoriaDataAccess
    {
        ...
        /// <summary>
        /// Obtener los registros de Categorias por RevisionD
        /// </summary>
        ...
        public static List<Categoria> ObtenerCategoriasPorRevisionD(int iRevision)
        {
            try
            {
                ...
                sqlcComando.Connection = sqlcConectar;
                sqlcComando.CommandType = CommandType.StoredProcedure;
                sqlcComando.CommandText = "web_spS_ObtenerCategoriasPorRevisionD";
            ...
            {
                throw new Exception("Error capa de datos (public static List<Categoria> ObtenerCategoriasPorRevisionD(int " + iRevision + ")): " + ex.Message);
            }
        }
