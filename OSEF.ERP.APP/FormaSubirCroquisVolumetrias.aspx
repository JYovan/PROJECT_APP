<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormaSubirCroquisVolumetrias.aspx.cs" Inherits="OSEF.ERP.APP.FormaSubirCroquisVolumetrias" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/subirCroquisVolumetria.js"></script>
</head>
<body class="xCustomBody">
    <form id="form1" runat="server">
        <ext:ResourceManager ID="rmFormaSubirImagenesVolumetria" runat="server" HideInDesign="true" />

        <ext:GridPanel
            ID="gpSubirImagenessVolumetria"
            runat="server"
            Width="700"
            Height="300"
            ...
            <Store>
                <ext:Store ID="sSubirImagenesVolumetria" runat="server">
                    <Model>
                        <ext:Model ID="mSubirImagenessVolumetria" runat="server" IDProperty="ID">
                            <Fields>
            ...
            <TopBar>
                <ext:Toolbar ID="tbSubirImagenesVolumetria" runat="server">
                    <Items>
                        <ext:MultiUpload
                            ID="muSubirImagenesVolumetria"
                            runat="server"
                            OnFileUpload="muSubirImagenesVolumetria_OnFileUpload"
                        ...
                        <ext:Button
                            ...
                            Text="Cancelar Todo"
                            Icon="Decline"
                            Handler="#{muSubirImagenesVolumetria}.abortAllUploads();" />
                        <ext:Button
                            ID="btnEliminar"
                            runat="server"
                            Text="Eliminar"
                        ...
                        <ext:Button
                            ...
                            Text="Eliminar Todo"
                            Icon="Delete"
                            Handler="#{muSubirImagenesVolumetria}.removeAllUploads();" />
                    </Items>
                </ext:Toolbar>
            </TopBar>
