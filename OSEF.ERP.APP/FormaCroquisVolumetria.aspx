<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FormaCroquisVolumetria.aspx.cs" Inherits="OSEF.ERP.APP.FormaCroquisVolumetria" %>
            ...
            Ext.Msg.show({
                ...
                fn: function (btn) { 
                    if (btn === 'yes') {
                        ...
                        App.sImagenesVolumetriaD.reload({
                            callback: function () {
...
<body>
    <form id="form1" runat="server">
        <ext:ResourceManager ID="rmImgenesVolumetriaD" runat="server" HideInDesign="true" />

        <ext:Store ID="sImagenesVolumetriaD" runat="server" >
            <Model>
                <ext:Model ID="mImagenesVolumetriaD" runat="server">
                    <Fields>
         ...
         <ext:Panel 
            ...
            <Items>
                <ext:DataView
                    ID="dvImagenesVolumetriaD"
                    runat="server"
                    ItemSelector="div.thumb-wrap"
                    EmptyText="No hay imagenes para mostrar"
                    StoreID="sImagenesVolumetriaD"
                    MultiSelect="true"
